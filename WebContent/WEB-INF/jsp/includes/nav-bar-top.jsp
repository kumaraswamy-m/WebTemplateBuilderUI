	...
	<div id="docUIBanner" class="docUIBannerDiv">
		<header class="bluemix-global-header" id="header1">
			<div class="bluemix-masthead">
				...
				<div class="icon-bluemix-nav-menu"
					tabindex="1" id="header-menu"></div>
				<a href="${contextPath}/home"
					class="bluemix-branding"><fmt:message key="navbar.title" />&nbsp;<span
					class="bluemix-product-title"><fmt:message key="navbar.title.generator" /></span></a>
			</div>
		</header>
	</div>
</div>
